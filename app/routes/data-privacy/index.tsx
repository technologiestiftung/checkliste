	...
	return (
		<>
			...
			<div className="flex flex-col lg:max-w-[974px] mx-auto">
				<div className="w-full flex flex-col gap-4 lg:gap-6 pt-6 pb-9 lg:py-12 px-7.5 lg:px-0 text-base lg:text-[20px]">
					<h1 className="text-3xl lg:text-[50px] font-bold text-berlin-blue-900 lg:mt-4">
						{i18n("dataPrivacy.title")}
					</h1>
					<h3 className="lg:mt-8 text-xl lg:text-[20px]  font-bold text-berlin-blue-900">
						{i18n("dataPrivacy.subtitle")}
					</h3>
					<h2 className="mt-8 lg:mt-10 text-2xl lg:text-[28px] font-bold text-berlin-blue-900">
						{i18n("dataPrivacy.title.p1")}
					</h2>
					<h3 className="mt-2 lg:mt-4 text-xl lg:text-[20px] font-bold text-berlin-blue-900">
					...
					/>
					<h3 className="mt-4 lg:mt-8 text-xl lg:text-[20px] font-bold text-berlin-blue-900">
