const es = {
	...
	intro:
		"Esta aplicación ayuda a preparar su cita en el Oficina de Ciudadanos de Berlín. Responda a unas preguntas y crearemos una lista de documentos que necesitará llevar.",
	"context.p1": "Esta aplicación es un prototipo de",
	"context.p2": "Berlin y actualmente se está utilizando para una prueba.",
	"navigation.title": "Seleccione un servicio",
	"navigation.description": "Descubra qué documentos necesita",
	"navigation.button": "Comenzar",
	"navigation.id-card": "Solicitar un DNI",
	"navigation.certificate-of-conduct": "Solicitar un certificado de conducta",
	"navigation.residence-registration":
		"Registro de residencia – Apartamento único o residencia principal",
	yes: "Sí",
	no: "No",
	download: "Descargar",
	...
	"logo.t3": "En colaboración con Bürgeramt der Zukunft",
	"logo.t4": "Con el apoyo de",
