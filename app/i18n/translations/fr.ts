const fr = {
	...
	*/
	...
	"navigation.startpage.mobile": "À la page d'accueil",
	...
	*/
	...
	About
	*/
	"about.title": "À propos du projet de liste de vérification",
	"about.text.p1":
		"Les bureaux citoyens de Berlin signalent que la raison la plus fréquente d'échec des rendez-vous est l'absence ou l'oubli des documents requis. Grâce à des questions courtes sur votre situation personnelle, l'application crée une liste de vérification personnalisée qui vous indique précisément quels documents sont nécessaires. Cela rend votre visite aux autorités plus efficace et moins stressante.",
	"about.text.p2": `Avec la liste de vérification, vous pouvez vous préparer à 
    <a class="font-bold hover:underline text-berlin-blue-500"
                            href="https://service.berlin.de/dienstleistung/120686/"
                            target="_blank"
                            rel="noopener noreferrer"
                        ">l'enregistrement d'une résidence principale</a>, 
    <a class="font-bold hover:underline text-berlin-blue-500"
                            href="https://service.berlin.de/dienstleistung/120703/"
                            target="_blank"
                            rel="noopener noreferrer"
                        ">la demande d'une carte d'identité</a> et d'un 
    <a class="font-bold hover:underline text-berlin-blue-500"
                            href="https://service.berlin.de/dienstleistung/120926/"
                            target="_blank"
                            rel="noopener noreferrer"
                        ">certificat de casier judiciaire</a> au bureau citoyen de Schlesische Strasse. 
    ...
    <a class="font-bold hover:underline text-berlin-blue-500"
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                        ">Bureau Citoyen du Futur</a> pour présenter les informations nécessaires de manière claire et ciblée. Grâce à sa disponibilité en sept langues, la liste de vérification est facilement accessible et utilisable par les citoyens berlinois.`,
	"about.text.p3": `Si vous souhaitez jeter un coup d'œil dans les coulisses, vous pouvez trouver le code source ouvert sur 
    <a class="font-bold hover:underline text-berlin-blue-500"
                        ...
                        ">GitHub</a>.`,
	"about.text.p4":
		"Bonne chance dans la préparation de votre visite aux autorités !",
};
