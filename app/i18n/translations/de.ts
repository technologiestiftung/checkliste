const de = {
	...
	*/
	...
	Feedback
	*/
	"feedback.question": "Haben Sie Feedback zur Anwendung?",
	"feedback.link":
	...
	Flow Wohnistz
	*/
	"first-registration.q1": "Melden Sie sich zum ersten Mal in Berlin an?",
	"first-registration.q2": "Sind Sie verheiratet?",
	"first-registration.q3": "Möchten Sie Ihre:n Ehepartner:in auch anmelden?",
	"first-registration.q4": "Haben Sie Kinder unter 18 Jahren?",
	"first-registration.q5": "Zieht ein Kind mit Ihnen um?",
	"first-registration.q6": "Ziehen insgesamt mehr als zwei Personen um?",
	"nationality.q1": "Haben Sie die deutsche Staatsangehörigkeit?",
