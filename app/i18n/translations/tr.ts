const tr = {
	...
	*/
	...
	"overview.forms-certificate-of-conduct.hint.text":
		"Adli sicil kaydını çevrimiçi başvurabilirsiniz. <a href='https://service.berlin.de/dienstleistung/120926/' target='_blank' class='font-bold hover:underline text-berlin-blue-500 visited:text-purple-500'>Buraya</a> tıklayın.",
	"overview.forms-residence-registration.hint.text":
		"İkamet kaydınızı çevrimiçi yapabilirsiniz. <a href='https://service.berlin.de/dienstleistung/120686/' target='_blank' class='font-bold hover:underline text-berlin-blue-500 visited:text-purple-500'>Buraya</a> tıklayın. Eğer çevrimiçi kaydolmayı tercih ederseniz, <a href='https://service.berlin.de/terminvereinbarung/termin/manage/' target='_blank' class='font-bold hover:underline text-berlin-blue-500 visited:text-purple-500'>randevunuzu iptal edin</a>.",
	...
	*/
	...
	"about.text.p2":
		"Belge Kontrolü ile başvurabilirsiniz: <a class='font-bold hover:underline text-berlin-blue-500 visited:text-purple-500' href='https://service.berlin.de/dienstleistung/120686/' target='_blank' rel='noopener noreferrer'>Ana ikamet kaydı</a>, <a class='font-bold hover:underline text-berlin-blue-500 visited:text-purple-500' href='https://service.berlin.de/dienstleistung/120703/' target='_blank' rel='noopener noreferrer'>Kimlik kartı başvurusu</a> ve <a class='font-bold hover:underline text-berlin-blue-500 visited:text-purple-500' href='https://service.berlin.de/dienstleistung/120926/' target='_blank' rel='noopener noreferrer'>Adli sicil kaydı</a> başvurusu. Uygulama, <a class='font-bold hover:underline text-berlin-blue-500 visited:text-purple-500' href='https://www.berlin.de/ba-friedrichshain-kreuzberg/politik-und-verwaltung/aemter/amt-fuer-buergerdienste/buergeramt-der-zukunft/buergeramt-der-zukunft-1461966.php' target='_blank' rel='noopener noreferrer'>Friedrichshain-Kreuzberg Belediyesi</a> ile işbirliği içinde geliştirilmiştir.",
	"about.text.p3":
